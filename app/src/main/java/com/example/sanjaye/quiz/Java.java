...
public class Java extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        javaTime = (TextView) findViewById(R.id.javaTimer);
        javaTime.setText("00:02:00");
        final CounterClass timer = new CounterClass(180000, 1000);
        timer.start();

        JavaQuestion = getResources().getStringArray(R.array.getJavaQuestion);
        getJava_A = getResources().getStringArray(R.array.javaA);
        getJava_B = getResources().getStringArray(R.array.javaB);
        getJava_C = getResources().getStringArray(R.array.javaC);
        getJava_D = getResources().getStringArray(R.array.javaD);
        get_JavaAnswer = getResources().getStringArray(R.array.javaAnswer);
        ...
        tvquest = (EditText) findViewById(R.id.tvQuestion);

        getA = (Button) findViewById(R.id.getA);
        getB = (Button) findViewById(R.id.getB);
        getC = (Button) findViewById(R.id.getC);
